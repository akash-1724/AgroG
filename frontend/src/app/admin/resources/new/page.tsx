  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: "Successfully added new educational article.",
      });
      ...
      <Card className="border-secondary/20 shadow-md">
        <CardHeader className="bg-primary/5 rounded-t-xl border-b border-primary/10">
          <CardTitle className="text-xl font-bold text-primary flex items-center gap-2">
            <BookOpen className="h-6 w-6 text-primary" /> Create Educational Resource
          </CardTitle>
          <CardDescription>Publish tutorials, articles or guidelines for farmers and consumers.</CardDescription>
        </CardHeader>
